...
const SideBar = () => (
  <section id="sidebar">
    ...
    <section className="blurb">
      <h2>About</h2>
      <p>Hi, I&apos;m Haritha. I am a <a href="https://icme.stanford.edu/">Stanford ICME</a> graduate, YC Alumni,
    ...
    <section id="footer">
      <ContactIcons />
      <p className="copyright">&copy; Haritha <Link to="/">mldangelo.com</Link>.</p>
    </section>
  </section>
);
